# Generated by Django 4.2.3 on 2024-01-04 07:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('converted_invoice_balance', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('converted_recurring_invoice_balance', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('converted_sales_order_balance', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('status', models.CharField(choices=[('Draft', 'Draft'), ('Sent', 'Sent')], default='Draft', max_length=150)),
                ('cid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.company')),
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.customer')),
            ],
        ),
        migrations.CreateModel(
            name='expenseaccount',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bankacc', models.CharField(blank=True, max_length=100, null=True)),
                ('cheq_id', models.CharField(blank=True, max_length=100, null=True)),
                ('creditcard', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor_gstin', models.CharField(default='', max_length=100)),
                ('customer_gsttype', models.CharField(max_length=100, null=True)),
                ('customer_gstin', models.CharField(default='', max_length=100)),
                ...
                ('status', models.CharField(choices=[('Draft', 'Draft'), ('Billed', 'Billed'), ('Save', 'Save')], default='Draft', max_length=150)),
                ('cid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.company')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paid_amount', models.FloatField(blank=True, max_length=100, null=True)),
                ('balance_amount', models.FloatField(blank=True, max_length=100, null=True)),
                ('payment_type', models.CharField(max_length=100, null=True)),
                ('cheque_no', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('upi_no', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('file', models.FileField(default='default.jpg', upload_to='sales')),
                ('gstnumber', models.CharField(default='NULL', max_length=150)),
                ('gsttype', models.CharField(default='NULL', max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_number', models.CharField(blank=True, max_length=100, null=True)),
                ('is_from_purchase_order', models.BooleanField(default=False)),
                ('status', models.CharField(choices=[('Draft', 'Draft'), ('Approved', 'Approved'), ('Save', 'Save'), ('Billed', 'Billed')], default='Draft', max_length=150)),
                ('cid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.company')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amtcredit', models.FloatField(default='0', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_name', models.CharField(blank=True, default=0, max_length=100, null=True)),
                ('purchase_order', models.CharField(blank=True, default=0, max_length=100, null=True)),
                ('source_supply', models.CharField(blank=True, max_length=100, null=True)),
                ('place_supply', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit_no', models.TextField(blank=True, max_length=100, null=True)),
                ('customer', models.CharField(max_length=100, null=True)),
                ('address', models.TextField(null=True)),
                ...
                ('billno', models.CharField(max_length=100, null=True)),
                ('subtotal', models.CharField(max_length=100, null=True)),
                ('cgst', models.TextField(blank=True, max_length=100, null=True)),
                ('sgst', models.TextField(blank=True, max_length=100, null=True)),
                ('igst', models.TextField(blank=True, max_length=100, null=True)),
                ...
                ('file', models.FileField(blank=True, default='default.png', null=True, upload_to='crdit_note/')),
                ('balance', models.TextField(blank=True, max_length=100, null=True)),
                ('payment_method', models.TextField(blank=True, max_length=100, null=True)),
                ('cheque_no', models.TextField(blank=True, max_length=100, null=True)),
                ('acc_no', models.TextField(blank=True, max_length=100, null=True)),
                ('upi_id', models.TextField(blank=True, max_length=100, null=True)),
                ('bank_id', models.TextField(blank=True, max_length=100, null=True)),
                ('cid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.company')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invtype', models.CharField(blank=True, max_length=100, null=True)),
                ('invid', models.BigIntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=100, null=True)),
                ('min_stock', models.CharField(default='0', max_length=100, null=True)),
                ('cid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.company')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.itemtable')),
            ],
        ),
        migrations.AddField(
            model_name='challan',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app1.company')),
                ('employeeid', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='app1.payrollemployee')),
            ],
        ),
        migrations.CreateModel(
            name='advancepayment',
